<?php include('../../app-assets/inc/adminheader.php'); ?>
<!DOCTYPE html>
    ...
    <div class="card gradient-ibiza-sunset"> <!-- bisa green-tea sama pomegranate -->
      <div class="card-content">
        <div class="card-body pt-2 pb-0">
          <div class="media">
            <div class="media-body white text-left">
              <h3 class="font-large-1 mb-0"><?php echo $fmt->formatCurrency($csaldo, $currency); ?></h3>
              <span>Saldo Company</span>
            </div>
            <div class="media-right white text-right">
              <i class="icon-pie-chart font-large-1"></i>
            </div>
