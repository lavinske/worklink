...
$resMutasi = mysqli_query($dbconnect, "SELECT * FROM mutasicompany");
?>
<!DOCTYPE html>
<html lang="en" class="loading">
  ...
  <div class="col-sm-12">
    <div class="content-header">View Mutasi Company</div>
    </div>
</div>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Detail Mutasi Company</h4>
        </div>
            ...
            <table class="table table-striped table-bordered text-inputs-searching" id="frilenser">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php custom_echo($mutasi['berita'],15); ?></td>
