...
$resWD = mysqli_query($dbconnect, "SELECT * FROM withdrawuser WHERE done='0'");

if(isset($_GET["id"])){
$id = $_GET["id"];
$getWD = "SELECT wu.*, f.pendsaldo FROM withdrawuser wu JOIN freelancer f ON wu.username = f.username WHERE wu.id='$id' AND wu.done = '0' LIMIT 1";
...
$query1 = "UPDATE freelancer SET pendsaldo='$temp_pend' WHERE id='$id'";
    $sql1 = mysqli_query($dbconnect, $query1);
    $query1 = "UPDATE freelancer SET pendsaldo='$temp_pend' WHERE id='$id'";
    $sql1 = mysqli_query($dbconnect, $query1);
    $query = "UPDATE withdrawuser SET done='1' WHERE id='$id'";
...
<html lang="en" class="loading">
  ...
  <div class="col-sm-12">
    <div class="content-header">View Request Withdraw dari User</div>
    </div>
</div>
