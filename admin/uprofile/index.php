...
$getData = "SELECT * FROM freelancer WHERE username = '$username'";
$result = mysqli_query($dbconnect, $getData);
$row = mysqli_fetch_assoc($result);
$gend = $row['gender'];
$about = $row['about'] == "" ? "This user doesn't want to explain him/herself." : $row['about'] ;
$ugender = $gend == 1 ? "Female" : "Male";
$umari = $row['marital'];
$ucall = $gend == 1 ? ($row['marital'] == 1 ? "Mrs." : "Ms.") : "Mr.";
$fJoined = date("F Y", strtotime($row['joined']));
$resAbility = mysqli_query($dbconnect, "SELECT fability.AbilityID, abilityName, iconClass, tooltip FROM fability INNER JOIN abilitycategory ON fability.AbilityID = abilitycategory.AbilityID WHERE username='$username'");
$resEducation = mysqli_query($dbconnect, "SELECT * FROM education WHERE username='$username' ORDER BY yearStart DESC");
if(!isset($row)) header('location: ../userlist');
}else{
        ...
        <div class="media profil-cover-details row">
          <div class="col-5">
            <div class="align-self-start halfway-fab pl-3 pt-2">
              <div class="text-left">
                <h3 class="card-title white"><?php echo $row['fname']." ".$row['lname'];?></h3>
              </div>
            </div>
          </div>
          <div class="col-2">
        ...
        <div class="profile-section">
          <div class="row">
            <div class="col-lg-12 col-md-12 text-center">
              <span class="font-medium-2 text-uppercase"><?php echo $ucall." ".$row['fname'];?></span>
              <p class="grey font-small-2">Freelancer</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="mb-3">
              ...
              <span class="d-block overflow-hidden"><?php echo $row['about']; ?>
              </span>
            </div>
            <hr>
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <a href="mailto:<?php echo $row['email']; ?>" class="d-block overflow-hidden"><?php echo $row['email']; ?></a>
                  </li>
                  <li class="mb-2">
                    <span class="text-bold-500 primary"><a><i class="ft-globe font-small-3"></i> Location:</a></span>
                    <span class="d-block overflow-hidden"><?php echo $row['location']; ?></span>
                  </li>
                </ul>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="no-list-style">
                  ...
                  <li class="mb-2">
                    ...
                    <a href="http://<?php echo $row['website']; ?>" class="d-block overflow-hidden"><?php echo $row['website']; ?></a>
                  </li>
                </ul>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="d-block overflow-hidden"><?php echo $row['phone']; ?></span>
                  </li>
                  <li class="mb-2">
                    <span class="text-bold-500 primary"><a><i class="ft-book font-small-3"></i> Joined:</a></span>
                    <span class="d-block overflow-hidden"><?php echo $row['joined']; ?></span>
                  </li>
                </ul>
              </div>
            </div>
