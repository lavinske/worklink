...
include('../../app-assets/inc/freelancerheader.php');

if(isset($_GET["id"]) && isset($_GET["accept"]) && $_GET["accept"] == 1){
  $id = $_GET["id"];
  $query = "INSERT INTO workqueue (projectID, useriD) 
              VALUES('$id', '$uname')";
...
$id = $_GET["id"];
$getJobQ = "SELECT w.*, c.companyname FROM work w JOIN company c ON w.cID = c.username WHERE projectid = '$id'";
...
<section class="quill-editor">
	<div class="row">
		<div class="col-12">
          ...
          <a href="../daftar/?id=<?php echo $row['projectID']; ?>&accept=1" class="btn btn-primary btn-lg">
                          Daftar
                        </a>
...
<!-- Snow Editor end -->
    ...
    <script src="../../app-assets/vendors/js/katex.min.js" type="text/javascript"></script>
    <script src="../../app-assets/vendors/js/highlight.min.js" type="text/javascript"></script>
    <script src="../../app-assets/vendors/js/quill.min.js" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN APEX JS-->
