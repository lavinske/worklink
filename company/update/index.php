...
if(isset($_GET['id']) && isset($_POST['updatejob'])){
  $id=$_GET['id'];
$errors = array();
    // REGISTER USER
...
$detailsok = str_replace($trigger, $rtf, $details);
  ...
  if (count($errors) == 0) {
    $query = "UPDATE work SET name='$title', duration='$deadline', amount='$amount', details='$detailsok' WHERE projectid='$id' AND cID='$uname'";
...
$dbconnect->close();
  ...
  $row = mysqli_fetch_assoc($result);
   $trigger = array("\\b", "\\eb", "\\u", "\\eu", "\\i", "\\ei","\\nl");
$rtf   = array("<b>", "</b>", "<u>","</u>","<i>","</i>","<br/>");
$detailsok = str_replace($rtf, $trigger, $row['details']);
            ...
            <form class="form form-horizontal" action="" method="POST">
              <div class="form-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="position-relative has-icon-left">
                      <input type="text" id="timesheetinput2" class="form-control" placeholder="Judul Pekerjaan" name="name" value="<?= $row['name']; ?>" required>
                      <div class="form-control-position">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      ...
                      <input name="deadline" type="number" class="form-control" placeholder="Tenggat Waktu" required value="<?= $row['duration']; ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      ...
                      <input name="amount" type="number" class="form-control" placeholder="Harga yang diberikan" name="rateperhour" required value="<?= $row['amount']; ?>">
                      <div class="input-group-append">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="position-relative has-icon-left">
                      <textarea name="details" id="timesheetinput7" rows="5" class="form-control" placeholder="Jelaskan pekerjaan yang anda mau secara detil, formatting RTF ada di bawah ini.." required><?= $detailsok; ?></textarea>
                      <div class="form-control-position">
                        <i class="ft-file"></i>
                      </div>
                    </div>
              ...
              <div class="form-actions right">
                ...
                <button name="updatejob" type="submit" class="btn btn-raised btn-primary">
