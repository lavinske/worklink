<?php include('../../app-assets/inc/companyheader.php');
  if (isset($_POST['update_dong'])) {
    ...
    $errors = array();
  $token = $_COOKIE['token'];
  $picfname = mysqli_real_escape_string($dbconnect, $_POST['fname']);
  $piclname = mysqli_real_escape_string($dbconnect, $_POST['lname']);
...
print_r($errors);
  ...
  if (count($errors) == 0) {
    ...
    $query = "UPDATE company SET picfname='$picfname', piclname='$piclname', whatsapp='$phone', address='$address', email='$email', photo='$frname'  WHERE username='$uname' AND enckey='$token'";
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <ul class="no-list-style">
                            <li class="mb-2">
                              ...
                              <input type="email" class="form-control" id="email" name="email" value="<?php echo $cemail; ?>" required>
                              <small class="text-muted">eg. 
                                <i>info@tempe.co
                                </i>
                              </small>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <ul class="no-list-style">
                            <li class="mb-2">
                              <span class="text-bold-500 primary">
                                <a>
                                  <i class="fad fa-globe font-small-3">
                                  </i> Address:
                                </a>
                              </span>
                              <textarea class="form-control" id="place" name="address" required><?php echo $caddress; ?></textarea>
                              <small class="text-muted">eg. 
