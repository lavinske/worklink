...
if(isset($_POST['wd'])){
  ...
  $user_check_query = "SELECT saldo FROM company WHERE username='$uname'";
  ...
  if (count($errors) == 0) {
    $temp_saldo = $csaldo-$nominal;
    $temp_pending = $pendcsaldo+$nominal;
    $query = "UPDATE company SET saldo='$temp_saldo', pendsaldo='$temp_pending' WHERE username='$uname' AND enckey='$token'";
    $sql = mysqli_query($dbconnect, $query);
    $query1 = "INSERT INTO withdrawcompany (username, norek, namabank, cabangbank, namarekening, nominal) 
